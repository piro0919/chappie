...
fn strings(lang: Lang) -> UpdaterStrings {
    match lang {
        ...
        Lang::Pt => UpdaterStrings {
            title: "Atualização",
            init_failed: |e| format!("Não foi possível iniciar o atualizador.\n{e}"),
            up_to_date: "Você está na versão mais recente.",
            check_failed: |e| format!("A verificação falhou.\n{e}"),
            available: |v| format!("A versão v{v} está disponível.\nAtualizar agora?"),
            ok: "OK",
            cancel: "Cancelar",
            download_failed: |e| format!("O download falhou.\n{e}"),
            install_failed: |e| format!("A instalação falhou.\n{e}"),
            install_done: "Atualização concluída.\nO app será reiniciado automaticamente.",
        },
        Lang::Ko => UpdaterStrings {
            title: "업데이트",
            init_failed: |e| format!("업데이터를 초기화하지 못했습니다.\n{e}"),
            up_to_date: "최신 버전을 사용 중입니다.",
            check_failed: |e| format!("확인에 실패했습니다.\n{e}"),
            available: |v| format!("새 버전 v{v}이(가) 있습니다.\n지금 업데이트할까요?"),
            ok: "확인",
            cancel: "취소",
            download_failed: |e| format!("다운로드에 실패했습니다.\n{e}"),
            install_failed: |e| format!("설치에 실패했습니다.\n{e}"),
            install_done: "업데이트가 완료되었습니다.\n앱이 자동으로 다시 시작됩니다.",
        },
        Lang::It => UpdaterStrings {
            title: "Aggiornamento",
            init_failed: |e| format!("Impossibile inizializzare l'aggiornatore.\n{e}"),
            up_to_date: "Stai usando l'ultima versione.",
            check_failed: |e| format!("Il controllo è fallito.\n{e}"),
            available: |v| format!("La versione v{v} è disponibile.\nAggiornare ora?"),
            ok: "OK",
            cancel: "Annulla",
            download_failed: |e| format!("Il download è fallito.\n{e}"),
            install_failed: |e| format!("L'installazione è fallita.\n{e}"),
            install_done: "Aggiornamento completato.\nL'app verrà riavviata automaticamente.",
        },
    }
}
